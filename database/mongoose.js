...
var MONGO_DB = process.env.MONGODB_URI || " ";
console.log('[mongoose] MONGODB_URI =', JSON.stringify(MONGO_DB));
// returning the cache ->
var cached = global.mongoCache;
if (!cached) {
...
var connectDatabase = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!MONGO_DB)
                    throw new Error("MONGODB_URI must be set in the .env ");
                if (cached.conn)
                    return [2 /*return*/, cached.conn];
                if (!cached.promise) {
                    cached.promise = mongoose_1.default.connect(MONGO_DB, { bufferCommands: false });
                }
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
            ...
            case 3:
                ...
                throw error_1;
            case 4:
                console.log("Connected to the Database,".concat(process.env.NODE_ENV, " - ").concat(MONGO_DB));
                return [2 /*return*/];
        }
    });
}); };
